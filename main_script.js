...
const cardsInfoList = [
  ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Nature', 'Animal (set B)', 'Clothes', 'Food (set A)', 'Food (set B)', 'Emotions', 'Body'],
  [
    {
      word: 'cry',
      translation: 'плакать',
...
const cardSound1 = document.querySelector('.card.n1 audio');
const cardSound2 = document.querySelector('.card.n2 audio');
const cardSound3 = document.querySelector('.card.n3 audio');
const cardSound4 = document.querySelector('.card.n4 audio');
const cardSound5 = document.querySelector('.card.n5 audio');
const cardSound6 = document.querySelector('.card.n6 audio');
const cardSound7 = document.querySelector('.card.n7 audio');
const cardSound8 = document.querySelector('.card.n8 audio');

// const sections = document.querySelectorAll('section');
// for (let section of sections) {
//     section.addEventListener('click', function() {
//       switch (section.getAttribute(this.id)) {
//         case 'action-1':
//             cardImg1.setAttribute('src', cardsInfoList[1][0].image);
//             break;
//       }
//     });
// }
